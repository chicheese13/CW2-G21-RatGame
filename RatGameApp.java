...
public class RatGameApp extends Application {
     ...
     * private final String MESSAGE = MOTDGetter2
     * RatTitle message = new RatTitle(MOTDGetter2.getMessage());
     * message.setTranslateX(0);
     * message.setTranslateY(HEIGHT / 3 - 40);
     * 
     * Label label = new Label(WORDS);
     * label.setWrapText(true);
     * label.
     * setStyle("-fx-font-family: \"Comic Sans MS\"; -fx-font-size: 20; -fx-text-fill: darkred;"
     * );
     * 
