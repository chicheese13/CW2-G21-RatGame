...
public class AdultRat extends NormalRat {
    ...
    // Default value for pregnancy attribute
    private final boolean DEFAULT_PREGNANCY_VALUE = false;
    // Default value for pregnancy count
    private final int DEFAULT_PREGNANCY_COUNT = 0;
    private final int MATING_WAIT_INTERVAL = 200;
    // Default cooldown for females in ticks
    private final int DEFAULT_COOLDOWN_VALUE_FEMALE = 400;
    private final int DEFAULT_COOLDOWN_VALUE_MALE =
            DEFAULT_COOLDOWN_VALUE_FEMALE  + MATING_WAIT_INTERVAL;
    // Default value for adult rat speed
    private final BigDecimal DEFAULT_ADULT_RAT_SPEED = new BigDecimal("0.02");
    // Default value for pregnant adult
    private final BigDecimal PREGNANT_FEMALE_RAT_SPEED = new BigDecimal(
            "0.01");
    // rat speed
    ...
    // Rat image sprites
    private final String COOLDOWN_SPRITE_MALE_NORTH = "cooldown-male-north";
    private final String COOLDOWN_SPRITE_MALE_EAST = "cooldown-male-east";
    private final String COOLDOWN_SPRITE_MALE_SOUTH = "cooldown-male-south";
    private final String COOLDOWN_SPRITE_MALE_WEST = "cooldown-male-west";

    private final String ADULT_MALE_RAT_SPRITE_NORTH = "male-rat-north";
    private final String ADULT_MALE_RAT_SPRITE_EAST = "male-rat-east";
    private final String ADULT_MALE_RAT_SPRITE_SOUTH = "male-rat-south";
    private final String ADULT_MALE_RAT_SPRITE_WEST = "male-rat-west";

    private final String COOLDOWN_SPRITE_FEMALE_NORTH = "cooldown-female-north";
    private final String COOLDOWN_SPRITE_FEMALE_EAST = "cooldown-female-east";
    private final String COOLDOWN_SPRITE_FEMALE_SOUTH = "cooldown-female-south";
    private final String COOLDOWN_SPRITE_FEMALE_WEST = "cooldown-female-west";

    private final String ADULT_FEMALE_RAT_SPRITE_NORTH = "female-rat-north";
    private final String ADULT_FEMALE_RAT_SPRITE_EAST = "female-rat-east";
    private final String ADULT_FEMALE_RAT_SPRITE_SOUTH = "female-rat-south";
    private final String ADULT_FEMALE_RAT_SPRITE_WEST = "female-rat-west";

    private final String ADULT_FEMALE_RAT_PREGNANT_SPRITE_NORTH =
            "female-pregnant-rat-north";
    private final String ADULT_FEMALE_RAT_PREGNANT_SPRITE_EAST =
            "female-pregnant-rat-east";
    private final String ADULT_FEMALE_RAT_PREGNANT_SPRITE_SOUTH =
            "female-pregnant-rat-south";
    private final String ADULT_FEMALE_RAT_PREGNANT_SPRITE_WEST =
            "female-pregnant-rat-west";
     ...
     * @param direction
     */
    public AdultRat(final Position position, final boolean gender,
            final boolean sterile, final double ratHealth,
            final char direction, final Level currentLevel) {
     ...
     * @return false
     */
    public boolean isMatabale(final AdultRat check) {
        if (!check.getSterile() && !check.getPregnant()
     ...
     */
    public void ratCollision(final AdultRat collidedRat) {
     ...
     * @param parameter
     */
    public void collision(final Object parameter) {
     ...
     */
    public void setRatWait(final boolean waiting) {
