...
public class BabyRat extends NormalRat {
  ...
  public void ratDeath() {
    ...
    // this.currentLevel.addRenderObject(new RenderScore(this.objectPosition, RAT_SCORE,
    // this.currentLevel));
  ...
  /**
   * Makes the baby rat grow up into an adult Removes instance of self and creates new instance of
   * an AdultRat
   */
  public void growUp() {
    // create an adult rat
    // might need the baby rat's current tickCounter.
    this.currentLevel.spawnRat(new AdultRat(this.objectPosition, this.ratGender, this.ratSterile,
        this.ratHealth, this.directionFacing, this.currentLevel));
  ...
  public String convertString() {
    return (this.ratGender + " " + this.ratHealth + " " + this.ratSterile + " "
        + this.damageCooldown + " " + this.ratSpeed + " " + this.directionFacing + " "
        + this.growCounter + " " + this.objectPosition.getPosition()[0] + " "
